...
export function PagePanel({ width }: { width: number }) {
  ...
  return (
    <div className="flex h-full flex-col border-r border-sidebar-border bg-sidebar-background overflow-hidden" style={{ width, minWidth: width }}>
      {/* Header */}
        ...
        {!selectedSection ? (
          ...
          pages.map((page) => (
            <button
              ...
              className={`flex w-full items-start px-3 py-2 text-xs transition-colors ${
